...
## Status
### Vector
Currently, most of the Vector Beginner functions ar implimented.  The Intermediate vector functions are the next priority. 
### Matrix
 A skeleton of matrix functions are currently implimented,  After the vector intermedite functions are finished, the matrix Beginner and then Intermediate functions are next.
