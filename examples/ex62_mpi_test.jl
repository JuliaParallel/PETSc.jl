...
@testset "ex62 MPI" begin
  ...
  # ── Solver-variant tests — disabled on CI (each spawns a new Julia process) ──
  # Uncomment to run locally: julia --project examples/ex62_mpi_test.jl

  # # 2 ranks — Q2/Q1 2D trig MMS
