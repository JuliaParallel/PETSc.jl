# ex69_exact.jl — Analytical exact solutions for the variable-viscosity Stokes problem.
#
# Translated from PETSc snes/tutorials/ex69.c (SolKxSolution, SolCxSolution).
#
# SolKx: exponentially varying viscosity η = exp(2*B*x)
#   SolKxSolution(pos, m, n, B)  → (vx, vz, p)
#
# SolCx: piecewise-constant viscosity with jump at x=xc
#   SolCxSolution(pos, m, n, xc, etaA, etaB)  → (vx, vz, p)
#
# Both solutions are for free-slip BCs on all walls of the unit square.

function SolKxSolution(pos, m, n, B)
    sigma = 1.0
    x  = pos[1]
    z  = pos[2]
    Z  = exp(2.0 * B * x)
  ...
  sum4 += u4
    ...
    return (sum1, sum2, sum5)  # (vx, vz, p)
end

function SolCxSolution(pos, m, n, xc, etaA, etaB)
    ...
    Z  = 0.0
    _PC1 = 0.0; _PC2 = 0.0; _PC3 = 0.0; _PC4 = 0.0
  ...
  t138 = t6 * xc
  t142 = t72 * t2
  t147 = 0.4e1 * t8 * t20 - 0.2e1 * t26 * t2 * t16 * t29 - 0.8e1 * t38 * t39 * t41 + 0.4e1 * t47 * t48 * t49 - 0.8e1 * t56 * t61 - 0.4e1 * t65 * t20 + 0.2e1 * t26 * t2 * t18 * t28 - 0.4e1 * t74 * t75 * t76 - 0.2e1 * t81 * t64 * t82 - 0.4e1 * t86 * t87 * t91 - t23 * t94 * t96 + 0.8e1 * t99 * t100 - 0.2e1 * t105 * t106 * t82 - 0.4e1 * t38 * t48 * t111 * t12 + 0.2e1 * t116 * ZB * t111 * t24 + 0.4e1 * t122 * t20 + 0.4e1 * t126 * pi * t17 * t128 + 0.8e1 * t132 * t133 * t135 + 0.4e1 * t74 * t138 * t76 - 0.2e1 * t142 * t4 * t18 * t28
  t149 = ZA * t25 * t2
  t150 = ZB * t28
  t154 = t35 * t5
  t155 = t72 * t154
  ...
  t397 = t396 * t162
  t415 = t37 * t48
  t418 = -0.32e2 * t364 * t365 * t221 - 0.16e2 * t370 * t373 - 0.4e1 * t331 * t48 * t41 + 0.4e1 * t86 * t23 * t53 * t6 * t2 * t90 + 0.2e1 * t385 * t177 * t23 * xc * t246 + 0.16e2 * t132 * t53 * t6 * t28 * t270 - 0.4e1 * t397 * t371 * t233 * t12 - 0.12e2 * t173 * t58 * t190 * t251 + 0.2e1 * t385 * t36 * pi * t23 * xc * t59 - 0.8e1 * t99 * t61 - 0.2e1 * t244 * t59 * t415
  t427 = t371 * t270 * t59
  t439 = t209 * t48
  t440 = t110 * t12
  t441 = t58 * t440
  ...
  t626 = t49 * t45
  t660 = t29 * t45
  t685 = 0.2e1 * t545 * t174 - 0.4e1 * t126 * pi * t24 * xc - 0.4e1 * t47 * t48 * t188 + 0.4e1 * t505 * t660 * t24 - 0.2e1 * t142 * t177 * t163 - 0.2e1 * t142 * t4 * t13 * t18 + 0.8e1 * t260 * t128 * t60 - 0.2e1 * t328 * t546 - 0.2e1 * t26 * t2 * t28 * t16 + 0.4e1 * t545 * t217 - 0.4e1 * t209 * t138 * t256
  t690 = t6 * pi
  t691 = ZA * t690
  t693 = t24 * t24
  t694 = t693 * xc
  ...
  t325 = t55 * t58
  t326 = t325 * t60
  t329 = 0.2e1 * t102 * t164 + 0.2e1 * t83 * t273 - 0.4e1 * t102 * t277 - 0.2e1 * t7 * t263 + 0.4e1 * t24 * t8 * t17 - 0.4e1 * t286 * t154 * t60 - 0.2e1 * t131 * t291 - t147 * t148 * t119 + 0.2e1 * t24 * t78 * t17 + 0.2e1 * t54 * t85 * pi * ZA * ZB - 0.4e1 * t226 * t305 - 0.2e1 * t70 * t66 + t147 * t256 * t95 + 0.4e1 * t237 * t312 + 0.2e1 * t111 * t315 - 0.8e1 * t319 * t96 - t111 * t193 - 0.8e1 * t324 * t326
  t332 = t8 * t95
  t335 = t136 * t85
  t337 = t256 * t227
  t340 = t177 * t119
  ...
  t488 = t67 * t72 * t1
  t490 = t39 * xc
  t501 = 0.4e1 * t374 * t355 * t52 + 0.2e1 * t446 * t470 - 0.8e1 * t475 * t53 - 0.2e1 * t446 * t437 - 0.4e1 * t36 * t38 * t39 * t15 * t12 - t116 * t485 + 0.8e1 * t488 * pi * t12 * t490 - t207 * t183 - 0.2e1 * t182 * t232 - 0.6e1 * t413 * t245 - 0.4e1 * t413 * t382
  t503 = t115 * t8
  t510 = t355 * t19
  t513 = t432 * t208
  t525 = t38 * t40 * t18
  ...
  t1161 = nz * t83
  t1173 = ZB * t12
  t1196 = 0.4e1 * t1161 * ZB * t39 * ZA - 0.4e1 * t215 * t1029 - 0.8e1 * t488 * pi * t39 * xc + 0.32e2 * t821 * ZA * t8 * t1173 * t18 - 0.8e1 * t427 * t147 + 0.6e1 * t701 * t165 - 0.16e2 * t926 * t927 * t1124 * t18 - 0.8e1 * t1091 * t63 * t57 - 0.8e1 * t442 * t209 - 0.8e1 * t462 * t660 - 0.6e1 * t398 * t35 * t52
  ...
  t179 = t59 * t15
  t184 = t15 * t15
  t193 = t139 * t140 + 0.4e1 * t56 * nz * t11 * t144 + 0.4e1 * t147 * t148 * ZB + 0.4e1 * t27 * t154 + 0.8e1 * t159 * t163 - 0.12e2 * t147 * t166 + 0.2e1 * t169 * t170 - 0.16e2 * t174 * t175 * t124 + 0.2e1 * t33 * t179 * t20 - 0.2e1 * t33 * t11 * t36 * t184 + 0.2e1 * t56 * t61 * pi * ZA * ZB
  t194 = t173 * pi
  t195 = xc * t15
  t196 = t195 * t19
  t202 = t15 * t115
  ...
  t915 = t89 * t145
  t947 = t139 * t140 * t29
  t952 = -0.2e1 * t173 * t904 + 0.4e1 * t426 * t907 + 0.12e2 * t253 * t10 * t1 * pi * t244 + 0.8e1 * t95 * t915 - t36 * t355 - 0.16e2 * t794 * t771 - 0.8e1 * t511 * t723 + 0.16e2 * t734 * t162 + t36 * t837 + 0.2e1 * t298 * t299 * t57 - 0.2e1 * t28 * t638 - 0.2e1 * t62 * t545 + 0.2e1 * t310 * t406 + 0.12e2 * t138 * t616 + 0.4e1 * t223 * t750 + t424 * t497 + 0.2e1 * t734 * t894 + 0.2e1 * t132 * xc * t18 * t10 - 0.16e2 * t70 * t947 + 0.32e2 * t891 * t947
  ...
  t106 = _PC3 * t5
  t120 = -0.4e1 * t30 * t32 * t63 + t63 + 0.4e1 * t24 * Z * t1 * t13 + 0.2e1 * t29 * Z * x * t3 - 0.4e1 * t58 * t51 * t13 - 0.2e1 * t106 * t2 + t32 * pi - 0.2e1 * t106 * t14 - 0.2e1 * t30 * t12 * t68 - 0.2e1 * t67 * t51 * t14 + 0.4e1 * t106 * t87
  t129 = sin(nx * pi * x)
  t155 = 0.2e1 * t30 * t15 + x * pi * t41 * t13 - 0.4e1 * t19 * nx * t129 * nz + t32 * pi * t20 + 0.2e1 * t106 * t68 + 0.2e1 * t106 * t20 * t2 - 0.4e1 * t106 * t1 * t13 - 0.2e1 * t11 * t4 + 0.2e1 * t4 * t45 + 0.2e1 * t24 * Z * t2 + 0.2e1 * t24 * Z * t14 + t12 * pi * t13
  t158 = t5 * Z
  ...
  t73 = nz * t19
  t86 = t28 * x
  t91 = 0.4e1 * t58 * t60 + 0.2e1 * t33 * t16 * t63 + 0.4e1 * t33 * t67 + 0.2e1 * t33 * t29 - x * pi * t73 * t8 - 0.2e1 * t53 + 0.2e1 * t32 * Z * x * t13 - 0.2e1 * t58 * t12 - 0.2e1 * t58 * t24 + t3 * pi + 0.4e1 * t86 * t2 * t19 * t8
  t94 = Z * t12
  t121 = -0.2e1 * t8 + 0.2e1 * t45 * t94 * t19 + 0.2e1 * t14 * t5 * t7 * t19 + 0.4e1 * t6 * t7 * t53 + 0.2e1 * t23 * t7 * t63 - 0.4e1 * t28 * t67 + 0.2e1 * t45 * t94 + 0.2e1 * t58 * t12 * t19 + t16 * pi * t8 + 0.2e1 * t14 * t15 - 0.2e1 * t28 * t14
  t146 = cos(nx * pi * x)
  t156 = -t3 * pi * t19 + 0.2e1 * t58 * t63 - 0.4e1 * t58 * t1 * t8 + 0.4e1 * t45 * Z * t1 * t8 - 0.2e1 * t28 * t34 + 0.2e1 * t86 * t73 * t24 + 0.4e1 * t3 * t15 * t8 + 0.4e1 * t45 * Z * t60 + 0.4e1 * t18 * t146 * t8 + 0.2e1 * t45 * Z * t24 + 0.2e1 * t16 * t15 * t24
  t159 = t4 * Z
  ...
  t48 = t12 * t20
  t52 = t17 * t20
  t57 = -0.2e1 * t4 * t13 - 0.4e1 * t18 * t19 * t20 - 0.2e1 * t8 * t24 * t12 - 0.2e1 * t29 * t30 * t31 + 0.2e1 * t8 * t2 * _PC2 * Z - 0.2e1 * t8 * t2 * t40 * t12 - 0.2e1 * t44 * t19 * t31 - 0.4e1 * t18 * t40 * t48 + t20 + 0.4e1 * t28 * t52 + t17 * pi * t12
  t58 = t9 * t31
  t61 = _PC3 * t1
  t62 = t12 * t31
  t73 = t5 * t20
  t78 = _PC1 * t1
  t90 = Z * t12
  t94 = 0.2e1 * t28 * t58 + 0.2e1 * t61 * t62 + 0.2e1 * t61 * t12 * t6 - 0.4e1 * t4 * t17 * t48 + 0.2e1 * t28 * t8 + 0.4e1 * t61 * t73 - 0.2e1 * t8 * t24 - 0.2e1 * t78 * Z * t6 - 0.2e1 * t44 * t40 * t62 - 0.2e1 * t78 * Z * t31 - t9 * pi * t20 + 0.2e1 * t78 * t90 * t6
  t101 = cos(nx * pi * x)
  t102 = t11 * t101
  t109 = t12 * t5
  t110 = t109 * t20
  t128 = 0.2e1 * t61 * t6 - t17 * pi + 0.2e1 * t102 * t5 - 0.4e1 * t17 * t24 * t20 + 0.4e1 * t78 * Z * t110 - 0.2e1 * t9 * t24 * t31 - 0.4e1 * t4 * t52 - 0.2e1 * t4 * t9 * t62 + x * pi * t30 * t20 - t5 - 0.4e1 * t78 * Z * t5 * t20
  ...
  t83 = nz * t16
  t84 = t83 * t19
  t95 = -t34 * t58 + 0.2e1 * t60 * t23 * t16 + 0.2e1 * t60 * nz * t19 - t11 * pi * t18 + 0.4e1 * t60 * t69 * t18 + 0.4e1 * t73 * t75 + 0.4e1 * t33 * t5 * t79 * t18 + 0.2e1 * t73 * t84 + 0.2e1 * t60 * t84 + 0.2e1 * t33 * t4 * t79 * t19 + 0.4e1 * t60 * t75
  t97  = t34 * t3
  t101 = Z * _PC1
  t102 = t16 * t19
  t106 = t16 * t18
  ...
  t164 = 0.2e1 * t28 * t47 + 0.2e1 * t11 * t54 * t19 + 0.2e1 * t8 * t101 * t16 + 0.2e1 * t33 * t30 - t11 * t58 * t18 + 0.2e1 * t29 * t54 * t16 + 0.4e1 * t34 * t54 * t18 + 0.4e1 * t97 * t101 * t106 - 0.2e1 * t15 * t18 * nx * t41 - t34 * pi + 0.2e1 * nz * t18

  u4 = (t57 + t95 + t135 + t164) / (0.4e1 * t24 * t15 + 0.8e1 * t127 * t15 * t18 + 0.4e1 * t131 * t15 * t19)


  u5 = (-2 * Z * nz * pi * u2 - u3 * 2 * nz * pi) * cos(nz * pi * z)  # pressure

  u6 = (u3 * 2 * nz * pi + 4 * Z * nz * pi * u2) * cos(nz * pi * z)  # zz stress
  sum5 += u5
  sum6 += u6

  u1 *= cos(nz * pi * z); # x velocity
  sum1 += u1
  u2 *= sin(nz * pi * z); # z velocity
  sum2 += u2
  u3 *= 2 * nz * pi * cos(nz * pi * z); # xx stress
  sum3 += u3
  u4 *= 2 * nz * pi * sin(nz * pi * z); # zx stress
  sum4 += u4
