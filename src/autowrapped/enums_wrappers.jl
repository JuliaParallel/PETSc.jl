...
@enum MatOperation begin
    ...
    MATOP_GET_BLOCK_DIAGONAL = 139
    MATOP_GET_VBLOCK_DIAGONAL = 140
...
@enum SNESLineSearchReason begin
    ...
    SNES_LINESEARCH_FAILED_FUNCTION_DOMAIN = 2
    SNES_LINESEARCH_FAILED_OBJECTIVE_DOMAIN = 3
    SNES_LINESEARCH_FAILED_JACOBIAN_DOMAIN = 4
    SNES_LINESEARCH_FAILED_REDUCT = 5
    SNES_LINESEARCH_FAILED_USER = 6
    SNES_LINESEARCH_FAILED_FUNCTION = 7
end 
...
@enum TaoTermDuplicateOption begin
    TAOTERM_DUPLICATE_SIZEONLY = 0
    TAOTERM_DUPLICATE_TYPE = 1
end 

@enum TaoTermMask begin
    TAOTERM_MASK_NONE = 0
    TAOTERM_MASK_OBJECTIVE = 1
    TAOTERM_MASK_GRADIENT = 2
    TAOTERM_MASK_HESSIAN = 4 
end 

@enum TaoTermParametersMode begin
    TAOTERM_PARAMETERS_OPTIONAL = 0
    TAOTERM_PARAMETERS_NONE = 1
    TAOTERM_PARAMETERS_REQUIRED = 2
end 
...
@enum VecSignMode begin
    VEC_SIGN_ZERO_TO_ZERO = 0
    VEC_SIGN_ZERO_TO_SIGNED_ZERO = 1
    VEC_SIGN_ZERO_TO_SIGNED_UNIT = 2
end 
