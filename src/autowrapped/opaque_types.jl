# Opaque type declarations for argument types not defined elsewhere ------
...
mutable struct _n_FILE end
const FILE = Ptr{_n_FILE}

mutable struct _n_ISColoringValue end
const ISColoringValue = Ptr{_n_ISColoringValue}

mutable struct _n_ISLocalToGlobalMapping end
const ISLocalToGlobalMapping = Ptr{_n_ISLocalToGlobalMapping}
...
mutable struct _n_PetscRandom end
const PetscRandom = Ptr{_n_PetscRandom}

mutable struct _n_PetscRegressor end
const PetscRegressor = Ptr{_n_PetscRegressor}

mutable struct _n_PetscSection end
const PetscSection = Ptr{_n_PetscSection}

mutable struct _n_PetscSectionSym end
const PetscSectionSym = Ptr{_n_PetscSectionSym}
