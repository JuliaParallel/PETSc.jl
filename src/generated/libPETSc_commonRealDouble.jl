...
immutable PetscStageInfo{T}
    ...
    eventLog::PetscEventPerfLog{Float64}
    classLog::PetscClassPerfLog{Float64}
end
...
immutable PetscCoarsenData{T}
    pool_list::PetscCDArrNd{Float64}
    new_node::Union{Ptr{PetscCDIntNd{Float64}},StridedArray{PetscCDIntNd{Float64}},Ptr{PetscCDIntNd{Float64}},Ref{PetscCDIntNd{Float64}}}
    new_left::Integer
    chk_sz::Integer
    extra_nodes::Union{Ptr{PetscCDIntNd{Float64}},StridedArray{PetscCDIntNd{Float64}},Ptr{PetscCDIntNd{Float64}},Ref{PetscCDIntNd{Float64}}}
    array::Union{Ptr{Ptr{PetscCDIntNd{Float64}}},StridedArray{Ptr{PetscCDIntNd{Float64}}},Ptr{Ptr{PetscCDIntNd{Float64}}},Ref{Ptr{PetscCDIntNd{Float64}}}}
    size::Integer
    mat::Mat{Float64}
end
...
immutable TSMonitorDMDARayCtx{T}
    ray::Vec{Float64}
    scatter::VecScatter{Float64}
    viewer::PetscViewer{Float64}
    lgctx::TSMonitorLGCtx{Float64}
end
