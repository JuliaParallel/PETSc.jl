...
immutable PetscStageInfo{T}
    ...
    eventLog::PetscEventPerfLog{Float32}
    classLog::PetscClassPerfLog{Float32}
end
...
immutable PetscDrawViewPorts{T}
    nports::Integer
    xl::Union{Ptr{Float32},StridedArray{Float32},Ptr{Float32},Ref{Float32}}
    xr::Union{Ptr{Float32},StridedArray{Float32},Ptr{Float32},Ref{Float32}}
    yl::Union{Ptr{Float32},StridedArray{Float32},Ptr{Float32},Ref{Float32}}
    yr::Union{Ptr{Float32},StridedArray{Float32},Ptr{Float32},Ref{Float32}}
    draw::PetscDraw{Float32}
    port_xl::Float32
    port_yl::Float32
    port_xr::Float32
    port_yr::Float32
...
immutable PetscCoarsenData{T}
    pool_list::PetscCDArrNd{Float32}
    new_node::Union{Ptr{PetscCDIntNd{Float32}},StridedArray{PetscCDIntNd{Float32}},Ptr{PetscCDIntNd{Float32}},Ref{PetscCDIntNd{Float32}}}
    new_left::Integer
    chk_sz::Integer
    extra_nodes::Union{Ptr{PetscCDIntNd{Float32}},StridedArray{PetscCDIntNd{Float32}},Ptr{PetscCDIntNd{Float32}},Ref{PetscCDIntNd{Float32}}}
    array::Union{Ptr{Ptr{PetscCDIntNd{Float32}}},StridedArray{Ptr{PetscCDIntNd{Float32}}},Ptr{Ptr{PetscCDIntNd{Float32}}},Ref{Ptr{PetscCDIntNd{Float32}}}}
    size::Integer
    mat::Mat{Float32}
end
...
immutable TSMonitorDMDARayCtx{T}
    ray::Vec{Float32}
    scatter::VecScatter{Float32}
    viewer::PetscViewer{Float32}
    lgctx::TSMonitorLGCtx{Float32}
end
